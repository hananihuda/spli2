    ...
    <table class="table">
        ...
        <tbody>
            ...
            ?>
                    ...
                    <td><?= $pelajar['notel']; ?></td>
                    <td>
                        <a href="papar_detailPel.php?id_user=<?php echo   $pelajar['id_user']; ?>" class="btn btn-info btn-sm">LIHAT</a>    
        ...
        <br>
    <center>
    <a href="index.php" class="btn btn-primary" role="button">Log Keluar</a>
    </center>
