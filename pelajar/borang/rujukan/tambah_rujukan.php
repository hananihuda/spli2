...
<center>
  <div class="card"style="width: 45rem;">
    ...
    <form action="pros_tambah_rujukan.php" class="form-control" id="regForm" method="POST" novalidate>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-6">
          <input type="text" name="nama_rujukan" class="form-control" oninput="this.value = this.value.toUpperCase()" required><p>
        </div>
    </div>

    <div class="form-group row">
        <label for="jawatanrujukan" class="col-sm-3 col-form-label" > Jawatan :</label>
        <div class="col-sm-6">
          <input type="text" name="jawatan_rujukan" class="form-control" oninput="this.value = this.value.toUpperCase()" required><p>
        </div>
    </div>

    <div class="form-group row">
        <label for="notelrujukan" class="col-sm-3 col-form-label" > No Tel Rujukan :</label>
        <div class="col-sm-6">
          <input type="text" name="no_tel_rujukan" class="form-control" required><p>
        </div>
    </div>
