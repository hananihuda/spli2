...
require '../../../config.php';
$result=mysqli_query($conn,"SELECT * FROM rujukan LEFT JOIN pelajar ON pelajar.id_user=rujukan.id_user WHERE id_rujukan ='".$_GET['id_rujukan']."'");
    ...
    <body>
      ...
      <div class="card" style="width: 46rem;">
        <div class="card-header">
          ...
          <h3> Kemaskini Rujukan </h3>
        </div>
          <!--------------------------RESUME PELAJAR------------------------>
      
      <div class="card-body">
        <form action="pros_kemaskini_rujukan.php" class="form-control" id="regForm" method="POST" novalidate>

<input type="text" name="id_rujukan" class="form-control" value="<?php echo $row['id_rujukan']; ?>" hidden>

        <div class="form-group">
          <br>
        </div>
        <div class="form-group row">
        <label for="namarujukan" class="col-sm-3 col-form-label" > Nama Rujukan :</label>
        <div class="col-sm-6">
            <input type="text" name="nama_rujukan" class="form-control" value="<?php echo $row['nama_rujukan']; ?>" required>
        </div>
      </div>
      ...
      <div class="form-group row">
        <label for="jawatan_rujukan" class="col-sm-3 col-form-label" > Jawatan :</label>
        <div class="col-sm-6">
          <input type="text" name="jawatan_rujukan" class="form-control" value="<?php echo $row['jawatan_rujukan']; ?>" >
        </div>
      </div>
      ...
      <div class="form-group row">
        <label for="notel_rujukan" class="col-sm-3 col-form-label" > No Tel Rujukan :</label>
        <div class="col-sm-6">
      <input type="text" name="no_tel_rujukan" class="form-control" value="<?php echo $row['no_tel_rujukan']; ?>" >
