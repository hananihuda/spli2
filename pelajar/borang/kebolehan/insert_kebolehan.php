...
<center>
  <div class="card"style="width: 45rem;">
    <div class="card-header">
      <h4> Tambah Kebolehan </h4>
    </div>
    <div class="card-body">
      
    <!-- ACTION AFTER KLIK SUBMIT -->
    <form action="pros_insert_kebolehan.php" class="form-control" id="regForm" method="POST" novalidate>
...
<br>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-7">
          <input type="text" name="kebolehan" class="form-control" placeholder="Kebolehan Dalam Jawatan Yang Dimohon" required><p>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-6">
          <select id="select1" class="form-select" name="tahap_kebolehan" required>
