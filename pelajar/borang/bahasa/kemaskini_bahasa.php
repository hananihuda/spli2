...
<?php
	require '../../../config.php';
	$result=mysqli_query($conn, "SELECT * FROM bahasa WHERE id_bahasa='".$_GET['id_bahasa']. "'");
...
.navbar {
  margin-bottom: 20px;
    ...
    <body>
      ...
      <div class="card-body">
        <form action="pros_kemaskini_bahasa.php" class="form-control" id="regForm" method="POST" novalidate>
        <input type="text" name="id_bahasa" class="form-control" value="<?php echo $row['id_bahasa']; ?>" hidden>
        ...
        <label for="bahasa" class="col-sm-2 col-form-label"> Bahasa : </label>
          <div class="col-sm-6">
            <input type="text" name="bahasa" class="form-control" value="<?php echo $row['bahasa']; ?>" require>
            </div>
          </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10" >
          <select id="select1" class="form-select" name="tahap" value="<?php echo $row['tahap']; ?>">
