...
<center>
  <div class="card"style="width: 45rem;">
    ...
    <form action="pros_pengalaman_kerja.php" class="form-control" id="regForm" method="POST" novalidate>


    <h6 class="text-muted">Sila Isi Dengan Huruf Besar</h6>

    <div class="form-group row">
        <label for="nama_syarikat" class="col-sm-3 col-form-label" > Nama Syarikat :</label>
        <div class="col-sm-9">
          <input type="text" name="nama_syarikat" class="form-control" required><p>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
          <input type="text" name="jawatan_pass" class="form-control" required><p>
        </div>
    </div>

    <div class="form-group row">
        <label for="tarikhmula" class="col-sm-3 col-form-label" > Tarikh Mula :</label>
        <div class="col-sm-6">
          <input type="date" name="tarikh_mula" class="form-control" required><p>
        </div>
    </div>

    <div class="form-group row">
        <label for="tarikhtamat" class="col-sm-3 col-form-label" > Tarikh Tamat :</label>
        <div class="col-sm-6">
          <input type="date" name="tarikh_tamat" class="form-control" required><p>
        </div>
    </div>
    ...
    <br>
    <center><a href="../../papar_resume.php" class="btn btn-light" tabindex="-1"
    role="button" aria disabled="true">Ke Halaman Resume</a>
</form>
</center>
</main>
